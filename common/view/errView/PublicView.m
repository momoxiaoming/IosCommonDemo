...
+(void)indictorShow {
    ...
    pubV.frame = CGRectMake(0, DEF_STATUS_HEIGHT+64, DEF_SCREEN_WIDTH, DEF_SCREEN_HEIGHT-DEF_STATUS_HEIGHT-64-ShowDiff);
    BOOL have = NO;
...
+(void)showCenterGif:(UIView *)superView {
    ...
    _comment.frame = CGRectMake(0, DEF_SCREEN_HEIGHT-100-49-ShowDiff, DEF_SCREEN_WIDTH, 100);
    UIImage *gifImg = [UIImage imageNamed:@"center_gif"];
